...
steps/decode.sh --nj "$decode_nj" --cmd "$decode_cmd" \
 /home/main/Desktop/kaldi/egs/timit/s5/exp/mono/graph data/dev_clean exp/mono/decode_dev

steps/align_si.sh --boost-silence 1.25 --nj 10 --cmd "$train_cmd" \
                  data/dev_clean /home/main/Desktop/kaldi/egs/timit/s5/data/lang_test_bg \
                  /home/main/Desktop/kaldi/egs/timit/s5/exp/mono exp/decode_dev_clean
...
timit_dir=/home/main/Desktop/kaldi/egs/timit/s5

model_dir=$timit_dir/exp/tri4_nnet
out_base=exp/tri4_nnet_ppg
lang_dir=$timit_dir/data/lang


for part in dev_clean test_clean dev_other test_other train_clean_100; do
  # use underscore-separated names in data directories.
  steps/align_si.sh --boost-silence 1.25 --nj 10 --cmd "$train_cmd" \
                  data/$part /home/main/Desktop/kaldi/egs/timit/s5/data/lang_test_bg \
                  /home/main/Desktop/kaldi/egs/timit/s5/exp/mono exp/decode_$part

done

# decode_extra_opts=(--num-threads 6)

# steps/nnet2/decode.sh --cmd "$train_cmd" --nj 8 "${decode_extra_opts[@]}"\
#   $timit_dir/exp/mono/graph data/dev_clean $timit_dir/exp/tri4_nnet/decode_dev_clean

for split in dev_clean test_clean dev_other test_other train_clean_100; do
